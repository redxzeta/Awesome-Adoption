...
describe("Test rendered component", () => {
  test("data fetched matches petInfo snapshot", () => {
...
describe("Test click on share", () => {
  test("calls handleShare when share button clicked", () => {
    useFetch.mockReturnValue({
      data: {
        animal: {
          id: 124,
    ...
    const { getByTestId } = render(<PetInfo onClick={handleShare()} />);
    const button = getByTestId("btn-share");
