...
export const updateAuth = (sessionState: { session: Session; user: User; event: AuthChangeEvent }): SupaType => ({
  type: "UPDATE_AUTH",
  payload: sessionState
});

export const updateProfile = (profile: { username: string; favoritepets: FavoritePets[] }): SupaType => ({
  type: "UPDATE_PROFILE",
  payload: profile
});
